                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    <ul class="navbar-nav">                   
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                <a href="<?php echo $config['web']['base_url'] ?>admin/user" class="dropdown-item">Kelola Pengguna </a>
                                <a href="<?php echo $config['web']['base_url'] ?>admin/news/invite.php" class="dropdown-item">Registrasi </a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                <a href="<?php echo $config['web']['base_url'] ?>admin/deposit_method" class="dropdown-item">Metode deposit</a>
                                ...
                                <a href="<?php echo $config['web']['base_url'] ?>admin/deposit/report.php" class="dropdown-item">Laporan </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="javascript:void(0);" id="topnav-dashboard" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                <a href="<?php echo $config['web']['base_url'] ?>admin/order" class="dropdown-item">Pesanan </a>
                                <a href="<?php echo $config['web']['base_url'] ?>admin/order/report.php" class="dropdown-item">Laporan </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="javascript:void(0);" id="topnav-dashboard" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                ...
                                <a href="<?php echo $config['web']['base_url'] ?>admin/category" class="dropdown-item">Kategori </a>
                                <a href="<?php echo $config['web']['base_url'] ?>admin/service" class="dropdown-item">Layanan </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="javascript:void(0);" id="topnav-dashboard" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-dashboard">                                
                                <a href="<?php echo $config['web']['base_url'] ?>admin/news" class="dropdown-item">Informasi </a>
                                ...
                                <a href="<?php echo $config['web']['base_url'] ?>admin/news/gen-key.php" class="dropdown-item">Free Key </a>
                                <a href="<?php echo $config['web']['base_url'] ?>admin/news/cheat.php" class="dropdown-item">Cheat config </a>
                                <a href="<?php echo $config['web']['base_url'] ?>admin/page" class="dropdown-item">Halaman </a>
                            </div>
                        </li>
                    </ul>
                </div>
