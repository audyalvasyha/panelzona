...
?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo $config['web']['base_url'] ?>admin"> <i data-feather="airplay" class="icons-xs icon-dual-primary mr-1"></i> Admin </a>
                        </li>
                        <?php
}
?>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="<?php echo $config['web']['base_url'] ?>"> <i data-feather="airplay" class="icons-xs icon-dual-primary mr-1"></i> Dashboard </a>
                        </li>
                        <li class="nav-item">
